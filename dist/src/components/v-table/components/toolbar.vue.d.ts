...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    emit: (event: "add" | "batchDelete", ...args: any[]) => void;
    selectedRowKeys: Ref<string[] | number[]> | undefined;
    visible: Ref<boolean>;
    form: Ref<{
        formItem: {
            title: string;
    ...
    onBeforeAddModalOpen: import("vue").ComputedRef<(() => boolean | void) | undefined>;
    handleClickAdd: () => Promise<void>;
    ModalForm: import("vue").DefineComponent<{
        type: {
        ...
        props: {
            ...
            visible: boolean;
            title: string;
            renderParams?: import("../../../types/global").BaseObj | undefined;
        };
        emit: (event: "update:visible" | "okEvent", ...args: any[]) => void;
        config: TableConfig<import("../../../types/global").BaseObj> | undefined;
        form: Ref<{
            formItem: {
                title: string;
                dataIndex: string;
